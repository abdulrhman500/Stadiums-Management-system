...
SELECT * FROM match
SELECT * FROM stadium
UPDATE STADIUM SET capacity = 1000
...
(  1,8,'2017-08-1 20:00','2019-08-1 23:00',5 ),
...
(  6,7,'2023-08-1 20:00','2023-08-1 23:00' ,1),
(  6,7,'2023-08-1 20:00','2023-08-1 23:00' ,1),
(  8,4,'2022-08-1 20:00','2024-08-1 23:00',4),
(  2,4,'2021-08-1 20:00','2024-08-1 23:00',2),
(2,4,'2020-08-1 20:00','2024-08-1 23:00',2),
(  1,4,'2020-08-1 20:00','2027-08-1 23:00',3);
--select * from Match;
...
('555','Fan','2001-10-10','Rehab',015,1),
